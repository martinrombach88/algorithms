public class c33 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(canPack (2, 1, 5)); //returns true --> 1 big bag covers the goal. Second big bag shouldn't be used.

        System.out.println(canPack (26, 0, 70)); //returns true --> (26 * 5) > 70 and 70 / 5 = 0
    }
    ...
    //Modulo and decrementing while loops are good tools for handling number division.
}